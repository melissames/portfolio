      ...
      <div className="portfolio-container">
        ...
        <div className="portfolio-list">
          <div className="portfolio-item">
            <div>
              <img src={ComingSoon} alt="" className="portfolio-coming-soon"></img>
          ...
          <div className="portfolio-item">
            <div>
              <img src="http://g.recordit.co/HqvTY0cAdw.gif" alt="" className="portfolio-bark-co"></img>
              <h2>Bark.co</h2>
          ...
          <div className="portfolio-item">
            <div>
              <img src={PXL8} alt="" className="portfolio-pie-chart"></img>
              <h2>PXL8</h2>
